...
// centrosturist, productos y actividadturist
// son los nombres que se usan en el controlador
// para enviar los datos a la vista
// centrosturist es la lista de centros turísticos
// productos es la lista de productos turísticos
...
onMounted(() => {
    if (props.flash?.success) {
        setTimeout(() => {
            props.flash.success = null; // se oculta
        }, 5000);
    }
});
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-100">
                        <tr v-for="centro in centrosturist.data" :key="centro.idcentur"
                            ...
                            <td class="px-4 py-3 text-sm" >
                                ...
                                <img v-if="centro.imgcentur" :src="`/storage/${centro.imgcentur}`" alt="Imagen" class="rounded" width="75"/>
                            </td>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <NavLink :href="route('centrosturist.show', centro.idcentur)">
                                    <SecondaryButton >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <NavLink :href="route('centrosturist.edit', centro.idcentur)">
                                    <WarningButton> 
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <DangerButton  @click.prevent="openModalDelete(centro)">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
