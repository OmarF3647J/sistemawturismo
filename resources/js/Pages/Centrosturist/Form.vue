...
const form = useForm({
    ...
    horcentur: props.centrosturist ? props.centrosturist.horcentur : '',
    ...
    activo: props.centrosturist ? props.centrosturist.activo : '',
...
if (props.centrosturist != null) {
    ...
    form.horcentur = props.centrosturist.horcentur;
    ...
    form.activo = props.centrosturist.activo;
        ...
        <div class="grid gap-9 bg-white mb-8 md:grid-cols-2 rounded-lg">
            <div class="min-w-0 p-4 rounded-lg shadow-xs">
                ...
                <form class="mt-6 mb-6 space-y-6 max-w-xl" @submit.prevent="guardar">
                    ...
                    <InputGroup :text="'Horario Centro Turístico'" :required="'required'" v-model="form.horcentur">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>

                    </InputGroup>
                    <InputError :message="form.errors.horcentur" />
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="w-full md:w-1/2">
                            <InputGroup
                                :text="'Responsable Centro Turístico'"
                                :required="'required'"
                                v-model="form.rescentur"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <div class="w-full md:w-1/2">
                            <InputGroup
                                :text="'Telefono Centro Turístico'"
                                :required="'required'"
                                v-model="form.telcentur"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="w-full md:w-3/5 m-auto">
                    ...
                    <SelectMac :text="'Acepta Mascota:'" :required="'required'" v-model="form.activo" :options="optionsActivo" class="mt-4">        
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6Z" />
                        </svg>
