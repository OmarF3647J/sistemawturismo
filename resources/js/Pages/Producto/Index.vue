            ...
            <div class="w-full overflow-x-auto bg-white">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-100">
                        <tr v-for="producto in producto" :key="producto.producto"
                            class="text-gray-700">
                            <td class="px-4 py-3 text-sm">{{ producto.idproduct }}</td>
                            <td class="px-4 py-3 text-sm">{{ producto.nomproduct}}</td>
                            <td class="px-4 py-3 text-sm">
                                <SecondaryButton @click="openModalView(producto)">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <DangerButton @click="openModalDelete(producto)">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
