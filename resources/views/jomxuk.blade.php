...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/jomxuk/portada.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/jomxuk/2.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/jomxuk/3.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/jomxuk/5.jpg') }}">
  ...
  <!-- Titulo pestaña -->
  <title>Jomxuk – ¡Conoce este Centro Ecoturístico!</title>
...
<div class="imagen_full" style="background-image: url('{{ asset('images/jomxuk/portada.jpg') }}');">
      <div class="texto-sobre-full">
        @include('partials.title-jomxuk')
      </div>
</div>
...
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
  <div class="descripcion_centros">{{ $centros[7]->descentur }}</div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d294719.30923047836!2d-95.13601301027684!3d18.189089886696966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x85c20b8fbe48d4c1%3A0x9c3f122a1576601!2sCatemaco%2C%20Ver.!3m2!1d18.4212621!2d-95.1129658!4m5!1s0x85e9f221c212a189%3A0xf448cd038372015e!2sJomxuk%2C%20Centro%20Ecotur%C3%ADstico%2C%2095924%20Soteapan%2C%20Ver.!3m2!1d18.1531156!2d-94.8067372!5e1!3m2!1ses!2smx!4v1763196919355!5m2!1ses!2smx" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[7]->activo }}</b> acepta mascotas
</div>
...
<div class="actividades">
  ...
  @else
    <p>No hay actividades registradas para este centro (id = 8).</p>
  @endif
</div>
...
<script>
  const laboratorioImages = [
    '{{ asset('images/jomxuk/2.jpg') }}',
    '{{ asset('images/jomxuk/3.jpg') }}',
    '{{ asset('images/jomxuk/5.jpg') }}',
    '{{ asset('images/jomxuk/portada.jpg') }}',
    '{{ asset('images/jomxuk/6.jpg') }}',
    '{{ asset('images/jomxuk/4.jpg') }}'
  ];
