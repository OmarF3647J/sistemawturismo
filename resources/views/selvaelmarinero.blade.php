...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/roca-partida/4.jpg') }}">
  ...
  <!-- Titulo pestaña -->
  <title>Selva El Marinero – ¡Conoce este Centro Ecoturístico!</title>
...
<div class="imagen_full" style="background-image: url('{{ asset('images/selva-el-marinero/portada.jpg') }}');">
      <div class="texto-sobre-full">
        @include('partials.title-selvaelmarinero')
      </div>
</div>
...
<!---bounce left--->
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1">
      <div class="descripcion_centros">{{ $centros[14]->descentur }}</div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d60931.66879192169!2d-95.07259166061148!3d18.43707414076325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x85c20b8fbe48d4c1%3A0x9c3f122a1576601!2sCatemaco%2C%20Ver.!3m2!1d18.4212621!2d-95.1129658!4m5!1s0x85e9dc174361d2d5%3A0xbd05798a4a7b0eff!2sSelva%20del%20Marinero%2C%20Ecoturismo%20Campesino%20Conocido%2C%20Adolfo%20L%C3%B3pez%20Mateos%2095870%20Catemaco%2C%20Ver.!3m2!1d18.4393328!2d-94.96550049999999!5e1!3m2!1ses!2smx!4v1763347902723!5m2!1ses!2smx" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[14]->activo }}</b> acepta mascotas
</div>
...
<script>
  const laboratorioImages = [
    '{{ asset('images/selva-el-marinero/2.jpg') }}',
    '{{ asset('images/selva-el-marinero/3.jpg') }}',
    '{{ asset('images/selva-el-marinero/4.jpg') }}',
    '{{ asset('images/selva-el-marinero/portada.jpg') }}',
    '{{ asset('images/selva-el-marinero/5.jpg') }}',
    '{{ asset('images/selva-el-marinero/6.jpg') }}',
    '{{ asset('images/selva-el-marinero/7.jpg') }}',
    '{{ asset('images/selva-el-marinero/8.jpg') }}',
    '{{ asset('images/selva-el-marinero/9.jpg') }}',
    '{{ asset('images/selva-el-marinero/10.jpg') }}'
  ];
