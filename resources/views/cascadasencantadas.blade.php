...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/cascadas-encantadas/6.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/cascadas-encantadas/5.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/cascadas-encantadas/4.jpg') }}">
...
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
    <div class="descripcion_centros">{{ $centros[4]->descentur }}</div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d59729.49283116354!2d-95.10993468027165!3d18.408705219921!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0x85c20b8fbe48d4c1%3A0x9c3f122a1576601!2sCatemaco%2C%20Ver.!3m2!1d18.4212621!2d-95.1129658!4m5!1s0x85e9e12fc11ef059%3A0xf31ec8c01f68902f!2sCaba%C3%B1as%20cascadas%20encantadas%2C%20Catemaco%2C%20Ver.!3m2!1d18.368568!2d-95.0250976!5e1!3m2!1ses!2smx!4v1763193919177!5m2!1ses!2smx" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[4]->activo }}</b> acepta mascotas
</div>
...
<div class="actividades">
  ...
  @else
    <p>No hay actividades registradas para este centro (id = 5).</p>
  @endif
</div>
...
<script>
  const laboratorioImages = [
    '{{ asset('images/cascadas-encantadas/5.jpg') }}',
    '{{ asset('images/cascadas-encantadas/6.jpg') }}',
    '{{ asset('images/cascadas-encantadas/4.jpg') }}',
    '{{ asset('images/cascadas-encantadas/portada.jpg') }}',
    '{{ asset('images/cascadas-encantadas/7.jpg') }}',
    '{{ asset('images/cascadas-encantadas/2.jpg') }}'
  ];
