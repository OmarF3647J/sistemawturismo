...
<div class="carrusel_carreras js-flickity"
  ...
  <div class="carrusel_portadas">
    <a href="informatica.php"><img src="{{ asset('images/apompal/portada2.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
    <a href="ambiental.php"><img src="{{ asset('images/arrecifes/portada.jpg') }}" loading="lazy">
    ...
    <!--
    <div class="carrusel_portadas">
      <a href="mecatronica.php"><img src="{{ asset('images/cabanas-encantadas/portada.jpg') }}" loading="lazy">
    ...
    <div class="carrusel_portadas">
    <a href="mecatronica.php"><img src="{{ asset('images/cascadas-encantadas/portada.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/jomxuk/portada.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/kan-tasejkan/portada.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/laguna-del-ostion/BARRA_LAGUNADELOSTION.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/las-margaritas/portada.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/rancho-dona-elia/portada.jpg') }}" loading="lazy">
  ...
  <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/roca-partida/portada.png') }}" loading="lazy">
 ...
 <div class="carrusel_portadas">
  <a href="mecatronica.php"><img src="{{ asset('images/selva-el-marinero/portada.jpg') }}" loading="lazy">
