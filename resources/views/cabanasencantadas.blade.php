...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/cabanas-encantadas/2.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/cabanas-encantadas/5.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/cabanas-encantadas/8.jpg') }}">
...
<div class="imagen_full" style="background-image: url('{{ asset('images/cabanas-encantadas/portada.jpg') }}');">
...
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
    <div class="descripcion_centros">{{ $centros[3]->descentur }}</div>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[3]->activo }}</b> acepta mascotas
</div>
...
<div class="actividades">
  ...
  @else
    <p>No hay actividades registradas para este centro (id = 4).</p>
  @endif
</div>
...
<script>
  const laboratorioImages = [
    '{{ asset('images/cabanas-encantadas/2.jpg') }}',
    '{{ asset('images/cabanas-encantadas/5.jpg') }}',
    '{{ asset('images/cabanas-encantadas/8.jpg') }}',
    '{{ asset('images/cabanas-encantadas/portada.jpg') }}',
    '{{ asset('images/cabanas-encantadas/6.jpg') }}',
    '{{ asset('images/cabanas-encantadas/7.jpg') }}',
  ];
