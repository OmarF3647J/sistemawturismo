...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/benito-juarez/rio.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/benito-juarez/cascada2.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/benito-juarez/2.jpg') }}">
...
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
  <div class="descripcion_centros"> {{ $centros[2]->descentur }}</div>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[2]->activo }}</b> acepta mascotas
</div>
...
<div class="actividades">
  ...
  @else
    <p>No hay actividades registradas para este centro (id = 3).</p>
  @endif
</div>
...
<script>
  const laboratorioImages = [
    '{{ asset('images/benito-juarez/rio.jpg') }}',
    '{{ asset('images/benito-juarez/cascada2.jpg') }}',
    '{{ asset('images/benito-juarez/2.jpg') }}',
    '{{ asset('images/benito-juarez/portada.jpg') }}',
    '{{ asset('images/benito-juarez/6.jpg') }}',
    '{{ asset('images/benito-juarez/7.jpg') }}',
    '{{ asset('images/benito-juarez/12.jpg') }}',
    '{{ asset('images/benito-juarez/9.jpg') }}'
  ];
