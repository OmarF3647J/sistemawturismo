...
<meta charset="UTF-8">
  ...
  <link rel="preload" as="image" href="{{ asset('images/noimage.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/noimage.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/noimage.jpg') }}">
  <link rel="preload" as="image" href="{{ asset('images/noimage.jpg') }}">
  ...
  <!-- Titulo pestaña -->
  <title>El Mirador – ¡Conoce este Centro Ecoturístico!</title>
...
<div class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s">
    <div class="descripcion_centros">{{ $centros[6]->descentur }}</div>
...
<div class="mascotas">
  Este establecimiento <b>{{ $centros[6]->activo }}</b> acepta mascotas
</div>
...
<div class="actividades">
  ...
  @else
    <p>No hay actividades registradas para este centro (id = 7).</p>
  @endif
</div>
